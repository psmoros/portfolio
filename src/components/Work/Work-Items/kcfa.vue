<template>
  ...
  <div class="row work-item">
    <!-- Title  -->
    <div class="row">
      <p>Work — N°010 : King's Consulting & Financial Advisory Society</p>
    </div>
    <!-- Body  -->
    <div class="row">
      <!-- Carousel -->
      <div class="col-xl-6">
        <img class="d-block w-100" src="../../../assets/work/kcfa/website.jpg" alt="Second slide">
      </div>
      <!-- Description -->
